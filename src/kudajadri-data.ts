export const kudajadriData = {
  About: {
    title: 'Heritage Homestay Retreat in Wayanad',
    content:
  ...
  Home: {
    title: 'Welcome to Kudajadri Homestay',
    content:
      'Experience the perfect blend of luxury and nature at Kudajadri Homestay, where tranquility meets comfort.',
  },
};
