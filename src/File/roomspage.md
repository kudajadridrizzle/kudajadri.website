...
roomsIntro:
  ...
  content:
    Our rooms blend the charm of a 100-year-old Jain Tharavadu with modern
...
individualRooms:
  - id: classic-rooms
    ...
    description:
      An economic escape in a lush atmosphere. This is affordable luxury
      with no compromises.
    image: roomThree
    type: reverse
  ...
  - id: premium-rooms
    ...
    description:
      An Premium escape in a lush atmosphere. This is affordable luxury
      with no compromises.
    image: PremiumImg1
    type: normal
