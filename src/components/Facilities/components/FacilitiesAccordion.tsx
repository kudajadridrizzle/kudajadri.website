  ...
  const facilities = [
    ...
    },
    {
      ...
      content: [
        ...
        "Take a guided nature walk through the lush greenery surrounding the homestay. Explore nearby Wayanad cottages, enjoy scenic sightseeing, and spot birds, butterflies, and other wildlife while learning about the local flora and fauna.",
            ...
            >
              ...
              >
                <div className="px-6 pb-6 flex flex-col gap-4">
                  {facility.content.map((paragraph, i) => (
                    <p
                      key={i}
                      className="text-secondary font-albertSans text-base sm:text-lg leading-relaxed whitespace-pre-line"
                    >
                      {paragraph}
                    </p>
                  ))}
