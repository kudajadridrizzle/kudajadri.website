...
const AboutSession = () => {
  ...
  const { heading: legacyHeading, content: legacyContent } =
    parseMarkdown(Legacy);
  const { heading: idealForAllHeading, content: idealForAllContent } =
    parseMarkdown(IdealForAll);
