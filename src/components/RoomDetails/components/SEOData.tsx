...
{isHeritageRoom ? (
            ...
            <>
              ...
              <p className="text-secondary font-albertSans text-lg leading-relaxed mb-6">
                Booking a Deluxe Room in our cottages in Wayanad guarantees a
                memorable and relaxing holiday. Whether you are exploring
                nature, enjoying family time, or on a romantic getaway, these
                rooms provide the perfect base for your adventures.
              </p>
              ...
              <p className="text-secondary font-albertSans text-lg leading-relaxed mb-6">
                If you are looking for the best Wayanad cottages or cottages in
                Wayanad for a comfortable and memorable stay, our Deluxe Rooms
                are the ideal choice. Experience privacy, scenic beauty, and
                modern comfort while exploring everything Wayanad has to offer.
                Reserve your Deluxe Room today for an unforgettable holiday.
              </p>
            </>
          ) : isHeritageRoom ? (
            <>
              ...
              <ul className="list-disc pl-6 mb-8 space-y-2">
                <li className="text-secondary font-albertSans">
                  <strong>Edakkal Caves</strong> – Ancient rock carvings and
                  history
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Banasura Sagar Dam</strong> – Scenic views and leisure
                  activities
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Pookode Lake</strong> – Boating and nature walks
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Wayanad Wildlife Sanctuary</strong> – Wildlife
                  spotting
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Chembra Peak</strong> – Trekking and panoramic vistas
            ...
            <>
              ...
              <ul className="list-disc pl-6 mb-8 space-y-2">
                ...
                <li className="text-secondary font-albertSans">
                  <strong>Pookode Lake</strong> – Boating and scenic walks
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Banasura Sagar Dam</strong> – Stunning landscapes and
                  leisure spots
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Wayanad Wildlife Sanctuary</strong> – Safari and
                ...
                <li className="text-secondary font-albertSans">
                  <strong>Chembra Peak</strong> – Trekking and panoramic views
                </li>
              </ul>
            ...
            <>
              ...
              <ul className="list-disc pl-6 mb-8 space-y-2">
                <li className="text-secondary font-albertSans">
                  <strong>Budget Travelers</strong> – Affordable stay without
                  cutting down on comfort
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Families</strong> – Spacious rooms with homely vibes
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Couples</strong> – Quiet and private atmosphere
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Nature Lovers</strong> – Surrounded by greenery and
                  fresh air
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Workation Seekers</strong> – Wi-Fi and peaceful
                  setting for remote work
                </li>
              </ul>
              <p className="text-secondary font-albertSans text-lg leading-relaxed mb-6">
              ...
              <ul className="list-disc pl-6 mb-8 space-y-2">
                <li className="text-secondary font-albertSans">
                  <strong>Edakkal Caves</strong> – Famous for ancient carvings
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Pookode Lake</strong> – A scenic freshwater lake
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Soochipara Waterfalls</strong> – Perfect for adventure
                  lovers
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Wayanad Wildlife Sanctuary</strong> – Spot elephants
                  and other wildlife
                </li>
                <li className="text-secondary font-albertSans">
                  <strong>Chembra Peak</strong> – Popular trekking destination
                </li>
              </ul>
              <p className="text-secondary font-albertSans text-lg leading-relaxed mb-6">
